...
#ifndef GPUFLOW3D_CUDA_OPERATIONS_CUDA_OPERATION_CONVOLUTION_3D_H_
#define GPUFLOW3D_CUDA_OPERATIONS_CUDA_OPERATION_CONVOLUTION_3D_H_
...
class CudaOperationConvolution3D : public CudaOperationBase {
private:
  CUfunction cuf_convolution_rows_;
  CUfunction cuf_convolution_cols_;
  CUfunction cuf_convolution_slices_;
  ...
  void ResampleRows(CUdeviceptr input, CUdeviceptr output, DataSize4& input_size, size_t pitch) const;
  void ResampleColumns(CUdeviceptr input, CUdeviceptr output, DataSize4& input_size, size_t pitch) const;
  void ResampleSlices(CUdeviceptr input, CUdeviceptr output, DataSize4& input_size, size_t pitch) const;

public:
    CudaOperationConvolution3D();
...
#endif // !GPUFLOW3D_CUDA_OPERATIONS_CUDA_OPERATION_CONVOLUTION_3D_H_
